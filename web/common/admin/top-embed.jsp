...
<!-- text fonts -->
<link rel="stylesheet" href="${adminTemplateUrl}assets/fonts/fonts.googleapis.com.css" />

<!-- ace styles -->
<link rel="stylesheet" href="${adminTemplateUrl}assets/css/ace.min.css" class="ace-main-stylesheet" id="main-ace-style" />