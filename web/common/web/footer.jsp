        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="scroll-to-top">
                    <a href="#" class="bstore-scrollertop" style="display: block;"><i class="fa fa-angle-double-up"></i></a>
                </div>
            </div>
        </div>
    </div>
